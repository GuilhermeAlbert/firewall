          	...
          	<div class="col-lg-12">
            	<div class="p-5">
					<form class="user" method="post" id="form_settings_edit" name="form_settings_edit" action="{{ route('settings.edit_settings') }}">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-12 mb-12 mb-sm-0">
                                <hr><p><strong>{{ __('settings.os_settings') }}</strong></p>
                            </div>
                        </div>						

						<div class="form-group row">
                            <div class="col-sm-6 mb-6 mb-sm-0">
                                <label for="os_user_pass">{{ __('settings.user_root_password') }}</label>
								<input type="password" class="form-control" value="{{ $settings->os_user_pass }}" name="user_root_password" id="user_root_password" placeholder="{{ __('settings.user_root_password') }}" autocomplete="off">
                            </div>
                        </div>
