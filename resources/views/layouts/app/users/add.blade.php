...
<div class="container-fluid">
    ...
    <div class="card-body p-0">
        ...
        <div class="row">
          	...
          	<div class="col-lg-12">
            	<div class="p-5">
					<form class="user" method="post" name="form_user_add" action="{{ route('users.add_user') }}">
						@csrf
						<div class="form-group row">
							<div class="col-sm-12 mb-12 mb-sm-0">
								<label for="name">{{ __('users.name') }}</label>
								<input type="text" class="form-control" name="name" id="name" placeholder="{{ __('users.name') }}" autocomplete="off">
							</div>
						</div>
						<div class="form-group row">
							<div class="col-sm-12 mb-12 mb-sm-0">
								<label for="email">{{ __('users.mail') }}</label>
								<input type="text" class="form-control" name="email" id="email" placeholder="{{ __('users.mail') }}" autocomplete="off">
							</div>
						</div>
						<div class="form-group row">
							<div class="col-sm-12 mb-12 mb-sm-0">
								<label for="password">{{ __('users.password') }}</label>
								<input type="password" class="form-control" name="password" id="password" placeholder="{{ __('users.password') }}" autocomplete="off">
							</div>
						</div>
						<div class="form-group row">
							<div class="col-sm-12 mb-12 mb-sm-0">
